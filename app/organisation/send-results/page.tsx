    ...
    return (
      <Stack>
        <Alert icon={<IconAlertCircle />} title="No Organization Selected" color="yellow">
          Please select an organization to send results.
        </Alert>
      </Stack>
    );
  }
    ...
    <Stack>
      <div>
        ...
        <Text c="dimmed" size="sm" mt="xs">
          Send personalized assessment results via email to participants who have completed their assessments.
        </Text>
      </div>
              ...
              {completedParticipants.length === 0 ? (
                <Table.Tr>
                  <Table.Td colSpan={6} style={{ textAlign: 'center', padding: '2rem' }}>
                    <Text c="dimmed">
                      {loading ? 'Loading participants...' : 'No participants with completed assessments found'}
                    </Text>
                  </Table.Td>
                </Table.Tr>
              ) : (
                completedParticipants.map((participant) => (
                  ...
                  >
                    ...
                    <Table.Td>{participant.cohortName || 'N/A'}</Table.Td>
                    <Table.Td>
