...
const OrgDashboard = () => {
  return (
    <Tabs defaultValue="overall-report-pre" className="w-[400px]">
      <TabsList>
      ...
      <TabsContent value="overall-report-pre">
        <div className="space-y-4">
          ...
          <Tabs defaultValue="cohort-scoring" className="w-full">
            ...
            <TabsContent value="cohort-scoring" className="space-y-4 mt-4">
              {/* Content for Cohort Scoring */}
              Cohort Scoring Content
            </TabsContent>

            {/* Student Rankings subtab */}
            <TabsContent value="student-rankings" className="space-y-8 mt-4">
              <div className="space-y-4">
      ...
      <TabsContent value="overall-report-post">
        <h2>Overall Report - Post Only Content</h2>
      </TabsContent>
      <TabsContent value="pre-vs-post-comparison">
        <h2>Pre vs Post Comparison Content</h2>
      </TabsContent>
    </Tabs>
  );
};
